...
This project uses two complementary tools for AI agent support:

- **`@next/codemod agents-md`** — Embeds Next.js docs index into CLAUDE.md for `nextjs_docs` lookups
  - Update: `npx @next/codemod@canary agents-md --output /.claude/CLAUDE.md`
