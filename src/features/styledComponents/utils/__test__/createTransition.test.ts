...
const testPatterns: [
  ...
  [
    ['color'],
    { easing: 'steps(3,jump-start)' },
    'color 300ms steps(3,jump-start)',
  ],
  // optionsにキーを指定した時
  [
    ['color'],
    { easing: 'easeInOutQuint' },
    'color 300ms cubic-bezier(0.83, 0, 0.17, 1)',
  ],
  [
    ['color'],
    { easing: 'easeInOutBack' },
    'color 300ms cubic-bezier(0.68, -0.6, 0.32, 1.6)',
  ],
  // optionsがdelayのみのとき
